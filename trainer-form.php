...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Waste4Meal - Join as a Trainer Form </title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    move_uploaded_file($cv_tmp, "uploads/" . $cv_name);
	    ...
	    $od_name = $_FILES['other_documents']['name'];
    $od_tmp = $_FILES['other_documents']['tmp_name'];
    move_uploaded_file($od_tmp, "uploads/" . $od_name);
	
	    $id_name = $_FILES['id']['name'];
    $id_tmp = $_FILES['id']['tmp_name'];
    move_uploaded_file($id_tmp, "uploads/" . $id_name);

    // Define the path to your Excel file
    $excelFile = 'trainer_form.csv';
    ...
    // Add new form data
    $excelData[] = [$sur_name, $f_name, $o_name, $gender, $dob, $email, $phone, $cv_name, $od_name, $id_name];
