...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Waste4Meal - WICLUP Training Form </title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $excelFile = 'wiclup_training_data.csv';

    // Check if the file exists, if not, create it and add headers
    if (!file_exists($excelFile)) {
        $excelHeader = ["Surname", "Firstname", "Other names", "Gender", "Date of Birth", "Email","Phone Number", "State of origin", "Local goverment(origin)","Country of Origin", "State of residence", "Local goverment of residence","Country of residence", "Cluster"];
    ...
    // Add new form data
    $excelData[] = [$sur_name, $f_name, $o_name,$gender,$dob, $email, $phone,$state_origin,$lga_origin, $country_origin, $state_residence,$lga_residence,$country_residence, $cluster];
    ...
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
				...
				<div class="form-group row mb-5">
		          ...
		          <label>  Female:    <input type="radio"  value="female" id="gender" name="gender" required></label>
		            ...
		            <div class="form-group row">
		              <div class="col-md-6">
		                <label for="state_origin" class="text-black">State / Province of Origin <span class="text-danger">*</span></label>
		                <input type="text" class="form-control" id="state_origin" name="state_origin" required>
		              </div>
		              <div class="col-md-6">
		                <label for="c_postal_zip" class="text-black">Local Government of Origin<span class="text-danger">*</span></label>
		                <input type="text" class="form-control" id="lga_origin" name="lga_origin" required>
		              </div>
		            </div> <br>
       <div class="form-group">
		              <label for="country_origin" class="text-black">Country of Origin <span class="text-danger">*</span></label>
...
<option value="Zimbabwe">Zimbabwe</option>   
			...
			<br>
			   <div class="form-group">
		              <label for="c_country" class="text-black">Choose a cluster <span class="text-danger">*</span></label>
