...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Waste4Meal - Network partner Trainer Form </title>
		...
		<!-- Start Hero Section -->
			<div class="hero">
							<div class="intro-excerpt">
								<h1>Network partner Trainer Form</h1>
							</div>
						</div>
						<div class="col-lg-7">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $yt_handle = $_POST["yt_handle"];
    $other_handles = $_POST["other_handles"];
    $appointment = $_POST["appointment"];

    // Define the path to your Excel file
    $excelFile = 'network_partner_trainer_data.csv';

    // Check if the file exists, if not, create it and add headers
    if (!file_exists($excelFile)) {
        $excelHeader = ["Surname", "Firstname", "Other names", "Gender", "Date of Birth", "Email","Phone", "X Handle","Instagram Handle", "Facebook Handle", "Linkedin","Youtube Handle", "Other handles","Appointment"];
    ...
    // Add new form data
    $excelData[] = [$sur_name, $f_name, $o_name,$gender,$dob, $email, $phone,$x_handle, $ig_handle,$fb_handle,$linkedin,$yt_handle,$other_handles,$appointment];
...
?>
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
				...
				<div class="form-group row mb-5">
		          ...
		          <label>  Female:    <input type="radio"  value="female" id="gender" name="gender" required></label>
		              </div>
		              <div class="col-md-6">
					...
					<div class="form-group row mb-5">
		              ...
		              <div class="col-md-6">
				        ...
				        <div class="form-group row">
		              <div class="col-md-4">
		                <label for="x_handle" class="text-black">X handle</label>
		                <input type="text" class="form-control" id="x_handle" name="x_handle">
		              </div>
		              <div class="col-md-4">
		                <label for="ig_handle" class="text-black">Instagram handle</label>
		                <input type="text" class="form-control" id="ig_handle" name="ig_handle">
		              </div>
					     <div class="col-md-4">
		                <label for="fb_handle" class="text-black">Facebook ID</label>
		                <input type="text" class="form-control" id="fb_handle" name="fb_handle">
		              </div>
		            </div>
					
					        <div class="form-group row">
		              <div class="col-md-4">
		                <label for="linkedin" class="text-black">LinkedIn ID</label>
		                <input type="text" class="form-control" id="linkedin" name="linkedin">
		              </div>
		              <div class="col-md-4">
		                <label for="yt_handle" class="text-black">Youtube ID</label>
		                <input type="text" class="form-control" id="yt_handle" name="yt_handle">
		              </div>
					     <div class="col-md-4">
		                <label for="other_handles" class="text-black">Other social media handles</label>
		                <input type="text" class="form-control" id="other_handles" name="other_handles" placeholder="Pinterest - @abcdef">
		              </div>
		            </div>
					
					  <div class="form-group">
		       <label for="appointment" class="text-black">Book an Interview Appointment <span class="text-danger">*</span></label>
