...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Waste4Meal - Consultant  </title>
...
<script src=”https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js” integrity=”sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM” crossorigin=”anonymous”></script>
	...
	<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
		...
		<!-- Start Hero Section -->
			<div class="hero">
							<div class="intro-excerpt" class="col-6 col-md-6" data-aos="zoom-in">
								<h1>Consultant</h1>
								</div>
						</div>
		...
		<div class="why-choose-section">
			<div class="container">
				<div class="row justify-content-between align-items-center">
								<div class="waste-problem-container" class="col-6 col-md-6" data-aos="fade-up" data-aos-delay="150" data-aos-offset="150">


<p class="waste-problem-text">Monetize your wealth of knowledge and experience by joining us as a Consultant 
on the Waste4Meal project. We recognize the value of your expertise and offer 
you a unique platform to contribute while earning. </p>

<p class="waste-problem-text">As a vital part of our 
seasoned consultants, you will have the opportunity to make a lasting impact on 
the project's success. <a href="consultant-form.php" style="color:red;"><b>Click here</b></a>  to join us now and let your knowledge shape a 
sustainable future. Consultants earn a significant income, with monthly earnings 
ranging from $1200 to $5000 based on the areas of expertise. <a href="consultant-form.php" style="color:red;"><b>Click here to book 
a free appointment</b></a> 
 </p>
