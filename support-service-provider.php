...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Waste4Meal - Support Service Provider  </title>
		...
		<!-- Start Hero Section -->
			<div class="hero">
							...
							<div class="intro-excerpt" data-aos="zoom-in" >
								<h1>Support Service Provider</h1>
								</div>
						</div>
...
<p class="waste-problem-text">Contribute to the success of the Waste4Meal project by providing your expertise 
as a Support Service Provider. We are seeking services such as financial services, 
including insurances, supplies, security, logistics, engineering, and more. 
<p class="waste-problem-text">Your company or individual expertise is invaluable in supporting our project's diverse 
needs.</p>
<p class="waste-problem-text"> To proceed as a Consultant, Trainer, or Support Service Provider, book a 
virtual interview by clicking here. Following qualification, a membership 
payment of $100 is required. </p> 
<p class="waste-problem-text">This membership opens the door to significant 
income potential, ranging from $1200 to $5000 monthly, depending on the 
specific areas of specialty and contribution to the project's success.</p>
<p class="waste-problem-text">Join us in 
creating a sustainable future while thriving financially in your chosen area of 
expertise. <a href="network-partner-trainer-form.php" style="color:red;"><b> Click here to book a free appointment.</b></a> 
